...
public class MainClass {
    ...
    Auction a = new Auction(buyers, ai);

    System.out.println("The Winning Price is " + a.getWinningPrice());
    System.out.println("The Winning Buyer is " + a.getWinningBuyer().getName());
    }
}
